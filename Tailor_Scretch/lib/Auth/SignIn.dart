...
import 'package:tailor/Screens/ForgotPasswordActivity.dart';
import 'package:tailor/ApiRepositary.dart';
import 'package:tailor/Auth/SignUp.dart';
                  ...
                  Pinned.fromPins(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                            width: 1.0, color: UISupport.APP_PRIMARY_COLOR),
                      ),
                    ),
                  ),
                  Pinned.fromPins(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(padding: EdgeInsets.fromLTRB(0,15,25,0),
                              ...
                              Padding(
                                padding: const EdgeInsets.only(
                                    top: 30.0, right: 50, left: 50),
                                child: GestureDetector(
                                  onTap: () {
                                    if (_key.currentState!.validate()) {
                                      if (isEmail(
                                          editControllerEmailId.text.trim())) {
                                        if(editControllerPassword.text.trim().length>6){
                                          ...
                                          Map<String, String> body = {
                                            "email": editControllerEmailId.text.toLowerCase(),
