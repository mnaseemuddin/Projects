...
public class BottomUserProfile extends BottomSheetDialogFragment {
    ...
    private void handleClick() {
        ...
        binding.ivMore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PopupMenu popupMenu = new PopupMenu(binding.getRoot().getContext(), binding.ivMore);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (item.getTitle().equals("Kick")) {
                            kickUserDialog();
                        }
                        if (item.getTitle().equals("Report User")) {
    ...
    private void sendReport() {
        AlertDialog.Builder builderSingle = new AlertDialog.Builder(binding.getRoot().getContext());
        ...
        firebaseFirestore.collection(DBConstants.report_reasons)
                ...
                .addOnCompleteListener(task -> {
                    ...
                    for (DocumentChange documentChange : task.getResult().getDocumentChanges()) {
                        ReportReasonModel model = documentChange.getDocument().toObject(ReportReasonModel.class);
                        report_adapter.add(model.getReport_reason());
                    }
    ...
    private void addReport(String strName) {
        ...
        DocumentReference doc_ref = firebaseFirestore
                .collection(DBConstants.report_info)
                .document();
        ...
        firebaseFirestore
                ...
                .addOnCompleteListener(task -> {
                    ...
                    Commn.myToast(binding.getRoot().getContext(), "Report Added");
