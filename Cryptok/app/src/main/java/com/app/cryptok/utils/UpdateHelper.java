...
public class UpdateHelper {
    ...
    public  static  String KEY_UPDATE_TITLE="KEY_UPDATE_TITLE";
    public  static  String KEY_UPDATE_DESC="KEY_UPDATE_DESC";
    public  static  String APK_URL="https://play.google.com/store/apps/details?id=com.lgt.buzo_live";
    public interface OnUpdateCheckListener{
        void onUpdateCheckListener(String app_url,String update_title,String update_desc);
    }
    ...
    public  void check(){
        ...
        if (remoteConfig.getBoolean(KEY_UPDATE_ENABLE)){
            ...
            String desc=remoteConfig.getString(KEY_UPDATE_DESC);

      Commn.showDebugLog("currentVersion="+currentVersion+",appvesion="+appVersion+"");
            if (!TextUtils.equals(currentVersion,appVersion)&&onUpdateCheckListener!=null)
                onUpdateCheckListener.onUpdateCheckListener(updateURL,title,desc);
        }
    }
