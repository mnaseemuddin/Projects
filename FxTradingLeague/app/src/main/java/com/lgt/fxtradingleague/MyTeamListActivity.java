...
import com.lgt.fxtradingleague.Bean.BeanMyTeamList;
...
import static com.lgt.fxtradingleague.Config.PLAYERLIST;
import static com.lgt.fxtradingleague.Constants.MYTEAMLISTTYPE;
import static com.lgt.fxtradingleague.Constants.PLAYERLISTTYPE;
import static com.lgt.fxtradingleague.ContestListActivity.JoinMyTeamId;
...
public class MyTeamListActivity extends AppCompatActivity implements ResponseManager {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getUniqueID != null) {
            if (getUniqueID.hasExtra("UNIQUE_ID")) {
                mUniqueID = getUniqueID.getStringExtra("UNIQUE_ID");
                Log.e("jkljljkkljkljkl", mUniqueID + "");
            }
        }
    ...
    public void initViews() {
        ...
        Glide.with(context).load(ContestListActivity.team1Image).into(ivteam1Image);
        Glide.with(context).load(ContestListActivity.team2Image).into(ivteam2Image);
    ...
    JSONObject createRequestJson1() {
        ...
        try {
            ...
            Log.e("Dasdasdas", ContestListActivity.IntentMatchId + "" + ContestListActivity.JoinMyTeamId);
    ...
    public void getResult(Context mContext, String type, String message, JSONObject result) {
        ...
        Log.e("responseasmyteammmm", result + "");
                        ...
                        if (Role.equals("WK")) {
                           ...
                           /* im_GroundPlayerImage.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    startActivity(new Intent(MyTeamListActivity.this, ActivityPlayersInformation.class));
                                }
                            });*/

                            //Send to new detail page
    ...
    public class AdapterMyTeamList extends RecyclerView.Adapter<AdapterMyTeamList.MyViewHolder> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            TextView tv_MyTeamName, tv_MyTeamCaptain, tv_MyTeamViceCaptain, tv_MyWKCount, tv_MyBATCount, tv_MyARCount, tv_MyBOWLCount, tv_JoinContestTeam;
