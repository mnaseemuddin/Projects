...
public class Validations {
    ...
    public static void common_log(String msg) {
        ...
        try {
            ...
            new CountDownTimer(FlashMiliSec, 1000) {
                public void onTick(long millisUntilFinished) {
                    ...
                    String format = "%1$02d";
                    textView.setText("Starts in: " + String.format(format, Days) + "d " + String.format(format, Hours) + "h " + String.format(format, Minutes) + "m " + String.format(format, Seconds) + "s");
                }
