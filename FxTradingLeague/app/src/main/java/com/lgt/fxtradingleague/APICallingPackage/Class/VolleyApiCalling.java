package com.lgt.fxtradingleague.APICallingPackage.Class;
...
import com.lgt.fxtradingleague.APICallingPackage.Interface.ServerResponseListner;
import com.lgt.fxtradingleague.APICallingPackage.Interface.VolleyRestClient;
...
import static com.lgt.fxtradingleague.Config.Authentication;
...
public class VolleyApiCalling extends Activity implements VolleyRestClient {
    ...
    public void callRestApi(String url, final JSONObject jsonObject, final Context mContext,
        ...
        if (Validations.isNetworkAvailable(mContext)) {
            ...
            serverResponseListner.onError(" ", type);
