...
import com.lgt.fxtradingleague.Bean.BeanNotification;
...
import static com.lgt.fxtradingleague.Config.NOTIFICATIONLIST;
import static com.lgt.fxtradingleague.Constants.NOTIFICATIONTYPE;
...
public class NotificationActivity extends AppCompatActivity implements ResponseManager {
    ...
    JSONObject createRequestJson() {
        ...
        try {
            ...
            Log.e("idididi",sessionManager.getUser(context).getUser_id());
