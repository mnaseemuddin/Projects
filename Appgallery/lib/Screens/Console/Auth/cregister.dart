...
class CRegisterActivity extends StatefulWidget {

  const CRegisterActivity({Key? key}) : super(key: key);

  @override
  State<CRegisterActivity> createState() => _CRegisterActivityState();
}

class _CRegisterActivityState extends State<CRegisterActivity> {
