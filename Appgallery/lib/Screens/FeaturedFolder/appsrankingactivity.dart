...
class AppsRankingActivity extends StatefulWidget {
  const AppsRankingActivity({Key? key}) : super(key: key);

  @override
  _AppsRankingActivityState createState() => _AppsRankingActivityState();
}

class _AppsRankingActivityState extends State<AppsRankingActivity> {
