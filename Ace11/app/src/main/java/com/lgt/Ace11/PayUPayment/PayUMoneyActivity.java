...
public class PayUMoneyActivity  extends AppCompatActivity {
    ...
    */
    ...
    // Final Variables
    private String mMerchantKey = "UroZi1Vw";
    private String mSalt = "Rl7ptod6dUhnJAyNLgEZCdhE9d6DOJLxYJQ4xbw1Ipc=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ab.setTitle("title_activity_online_payment");
        ...
        if (bundle != null) {
            ...
            mFirstName = bundle.getString("sameer");
            mEmailId = bundle.getString("sameer@gmail.com");
            mAmount = bundle.getDouble("500");
            mPhone = bundle.getString("9999870918");
            mId = bundle.getInt("123442241");
            isFromOrder = bundle.getBoolean("PaymentShopping");
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    ...
                    if (url.equals(mSuccessUrl)) {
                        /*Intent intent = new Intent(PayUMoneyActivity.this, PayUPaymentConfig.class);
