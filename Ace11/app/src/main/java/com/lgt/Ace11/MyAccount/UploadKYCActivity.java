...
import static com.lgt.Ace11.Config.UPLOADDOUCMENT;
import static com.lgt.Ace11.Constants.UPLOADDOCUMENTTYPE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (PanOrAadhaar.equals("Pan")){
          //  tv_EtDocNameBottomText.setText("Name – As on PAN card");
           ...
           // tv_EtDocNumberBottomText.setText("10 digit number");
