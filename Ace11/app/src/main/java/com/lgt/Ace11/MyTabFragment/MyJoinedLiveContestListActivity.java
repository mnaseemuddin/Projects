...
import com.lgt.Ace11.Bean.BeanMyLiveJoinedContest;
...
import static com.lgt.Ace11.Config.MYJOINLIVECONTESTLIST;
import static com.lgt.Ace11.Constants.MYJOINLIVECONTESTLISTTYPE;
...
public class MyJoinedLiveContestListActivity extends AppCompatActivity implements ResponseManager {
    ...
    private static final String TAG = "MyJoinedLiveContestList";
   ...
   public static String team1,team2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_MyJoinedContestTimer.setText(IntentTime);
         ...
         team1=IntentTeamOneName.replaceAll(" ","");
         team2 =IntentTeamTwoName.replaceAll(" ","");
    ...
    JSONObject createRequestJson() {
        ...
        try {
            ...
            Log.e("matchhiddd",IntentMatchId);
