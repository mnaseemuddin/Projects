...
import 'samargin_textfield.dart';
import 'package:intl/intl.dart';

class TradeSettingsView extends GetView<TradeSettingsController> {
          ...
          child: ListView(children: [
            ...
            Obx(() => SACellContainer(child: Column(children: [
              ...
              Obx(() => controller.switchValue.value?TradeSettingCell(title: 'Martingale setup'.tr, trailing: Icon(Icons.chevron_right, color: ColorConstants.white,size: 40,),onPressed: () => Get.to(MarginConfigView(isMartingle: true,)),)
                  ...
                  Get.to(MarginConfigView());
                },),),

              TradeSettingCell(title: 'Sell Profit Trigger'.tr, subView: InputCell(
              ...
              TradeSettingCell(title: 'Sell Profit Position'.tr, subView: InputCell(
              ...
              //Add New
              TradeSettingCell(title: 'Sell Loss Position'.tr, subView: InputCell(
              ...
              TradeSettingCell(title: 'Buy_in_callback'.tr, subView: InputCell(controller: TextEditingController(text: '${controller.tradeResponse.value.buyCallback}'), onChanged: (val){
              ...
              TradeSettingCell(title: 'Loss callback trigger'.tr, subView:
              ...
              TradeSettingCell(title: 'Excess up trigger'.tr, subView:
              InputCell(controller: TextEditingController(text:
