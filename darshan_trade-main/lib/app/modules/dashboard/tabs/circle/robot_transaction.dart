...
class RobotTransactionRecord extends StatefulWidget {

  const RobotTransactionRecord({Key? key}) : super(key: key);

  @override
  _RobotTransactionRecordState createState() => _RobotTransactionRecordState();
}

class _RobotTransactionRecordState extends State<RobotTransactionRecord> {
  ...
  List<RobotTransationModel>? _list;

  @override
  void initState() {
    super.initState();

    getRobotTransactionAPI().then((value){
      if(mounted){
        setState(() {
          _list = value.data;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text('Transaction_record'.tr, style:
      textStyleHeading2(color: ColorConstants.white),),
      ...
      body: Stack(children: [
        _list !=null?_list!.isNotEmpty?Container(
          ...
          child: ListView.builder(itemBuilder: (context, index){
            RobotTransationModel model = _list!.elementAt(index);
            ...
            return Container(
              ...
              child: Column(children: [
                ...
                Row(children: [
                  ...
                  Text(model.orderdate, style: textStyleLabel()),
                ],),
              ],),
