...
class TransactionRecord extends StatefulWidget {
  ...
  const TransactionRecord({Key? key, this.symbol, required this.exchangeType}) : super(key: key);
...
class _TransactionRecordState extends State<TransactionRecord> {
  ...
  List<OrderTransactionResponse>? _list;

  @override
  void initState() {
    super.initState();
    getOrderTransactionAPI(symbol: widget.symbol).then((value){
      if(mounted){
        setState(() {
          _list = value.data;
      ...
      body: Stack(children: [
        _list !=null?_list!.isNotEmpty?Container(
          ...
          child: ListView.builder(itemBuilder: (context, index){
            OrderTransactionResponse model = _list!.elementAt(index);
            ...
            return Container(
              ...
              child: Column(children: [
                ...
                Row(children: [
                  ...
                  Text('${model.trade_amount}', style: textStyleLabel()),
                ...
                Row(children: [
                  ...
                  Text(model.transactTime, style: textStyleLabel()),
                ],),
              ],),
