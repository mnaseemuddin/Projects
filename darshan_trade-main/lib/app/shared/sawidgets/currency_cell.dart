...
class CurrencyCell extends StatefulWidget {
  ...
  const CurrencyCell({Key? key, required this.model, this.onPress}) : super(key: key);
      ...
      child: Container(
        ...
        child: Column(children: [
          ...
          Row(
            ...
            children: [
            Image.network("http://darshantrade.com/symbol/${widget.model.symbol.replaceAll('USDT', '').
            toLowerCase()}@2x.png", width: 40, height: 40),
