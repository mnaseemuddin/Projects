...
import com.app.superlive.databinding.ActivityAddShppingVideoBinding;
...
import static com.app.superlive.utils.Commn.getRealPathFromURI_API19;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @androidx.annotation.Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == 2) {
            ...
            try {
                ...
                } else if (timeInMilliSec > 50000) {
                    Commn.myToast(context, "Video Duration is too big please choose another video...");
                } else {
