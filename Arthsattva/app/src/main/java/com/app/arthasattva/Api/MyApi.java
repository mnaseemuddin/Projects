package com.app.arthasattva.Api;

import com.app.arthasattva.Interface.ApiService;
...
public class MyApi {
    ...
    public static String base_url = "http://13.126.139.24/api/";
    public static String upload_base_url = "http://13.126.139.24/";
    public static String web_url = "http://13.126.139.24/";
    public static String place_holder = upload_base_url + "icon/app_logo.png";
