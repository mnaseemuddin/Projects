package com.app.arthasattva.fragment.stream;
...
import com.app.arthasattva.databinding.FragmentAllViewersForViewersBinding;
...
public class AllViewersFragmentForViewers extends BottomSheetDialogFragment {
    ...
    private FragmentAllViewersForViewersBinding binding;

    private String user_id;
    ProfilePOJO profilePOJO;
    private SessionManager sessionManager;

    public AllViewersFragmentForViewers() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_all_viewers_for_viewers, container, false);
