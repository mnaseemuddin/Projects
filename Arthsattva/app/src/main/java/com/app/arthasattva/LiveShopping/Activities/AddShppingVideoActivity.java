...
import com.app.arthasattva.databinding.ActivityAddShppingVideoBinding;
...
import static com.app.arthasattva.utils.Commn.getRealPathFromURI_API19;
...
public class AddShppingVideoActivity extends AppCompatActivity {
    ...
    private void iniUploadVideo() {
        ...
        //this.getApplicationContext().getExternalFilesDir(null).toString();
        this.getApplicationContext().getExternalFilesDirs(null).toString();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @androidx.annotation.Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == 2) {
            ...
            try {
                ...
                Commn.showDebugLog("fileSizeInMB12:" + fileSizeInMB);
