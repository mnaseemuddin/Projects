...
import com.app.arthasattva.activity.AnotherUserProfile;
import com.app.arthasattva.activity.MainActivity;
import com.app.arthasattva.activity.SearchActivity;
import com.app.arthasattva.adapter.CountryListAdapter;
import com.app.arthasattva.adapter.ExploreHolder;
import com.app.arthasattva.databinding.ExploreStreamLayoutBinding;
import com.app.arthasattva.databinding.FragExploreBinding;
import com.app.arthasattva.model.CountryModel;
        ...
        streams_adapter = new FirestorePagingAdapter<ProfilePOJO, ExploreHolder>(streams_options) {
            ...
            protected void onBindViewHolder(@NonNull ExploreHolder hotLiveHolder, int position, @NonNull ProfilePOJO hotLiveModel) {
                ...
                if (hotLiveModel.getName().equals("")) {
                    holder_bind.tvLiveTitle.setText(hotLiveModel.getArthsId());
                } else {
