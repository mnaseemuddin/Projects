...
import com.app.arthasattva.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    /*private void loginWithFacebook() {
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onError(FacebookException error) {
                ...
                Commn.showDebugLog("facebook:onError" + error.getMessage());
                // ...
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Commn.myToast(context, task.getException().getMessage() + "");
    ...
    private void registerUser(int bonus) {
        ...
        profilePOJO.setArthsId("Arths" + arrangeString(USER_ID) + "");
