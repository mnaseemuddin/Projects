...
import com.app.arthasattva.activity.LiveActivity;
import com.app.arthasattva.databinding.FragmentGoPrivateLiveBinding;
...
public class GoPrivateLive extends Fragment {
    ...
    private void handleClick() {
      ...
      /*binding.allowPeoples.tvAllowSuggestion.setOnClickListener(view -> {
            setAllowSuggestion6();
        });*/
    ...
    private void setAllowSuggestion1() {
        binding.etPeoplesAllow.setText(binding.allowPeoples.tvAllowSuggestion1.getText().toString());
