...
import com.app.arthasattva.LiveShopping.Model.OrderHistoryModel;
import com.app.arthasattva.R;
import com.app.arthasattva.databinding.OrderHistoryLayoutBinding;

import java.util.ArrayList;
import java.util.List;

public class OrderHistoryAdapter extends RecyclerView.Adapter<com.app.arthasattva.LiveShopping.Adapter.OrderHistoryAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public com.app.arthasattva.LiveShopping.Adapter.OrderHistoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (context == null) {
            context = parent.getContext();
        }
        View view = LayoutInflater.from(context).inflate(R.layout.order_history_layout, parent, false);
        return new com.app.arthasattva.LiveShopping.Adapter.OrderHistoryAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull com.app.arthasattva.LiveShopping.Adapter.OrderHistoryAdapter.ViewHolder holder, int position) {
