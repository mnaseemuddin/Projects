...
import com.app.arthasattva.adapter.GlobalSliderAdapter;
import com.app.arthasattva.adapter.TimeLineAdapter;
import com.app.arthasattva.databinding.ActivityAnotherUserProfileBinding;
import com.app.arthasattva.model.PostsModel;
import com.app.arthasattva.model.ProfilePOJO;
import com.app.arthasattva.model.UsersImagesModel;
        ...
        firebaseFirestore.collection(DBConstants.UserInfo)
                ...
                .addOnCompleteListener(task -> {
                    if (task.getResult().exists()) {
                        ...
                        buzo_id = task.getResult().getString(DBConstants.arths_id);
                        ...
                        if (buzo_id != null) {
                            binding.tvBuzoId.setText("Arths ID : " + buzo_id + "");
                        }
                        if (bio != null) {
    ...
    private void sendNotification() {
        ...
        if (profilePOJO.getName() != null) {
            if (!profilePOJO.getName().isEmpty()) {
                notificationRequest.setMessage(profilePOJO.getName() + " followed you in "+getString(R.string.app_name));
            } else {
                notificationRequest.setMessage(profilePOJO.getArthsId() + " followed you in "+getString(R.string.app_name));
            }
        } else {
            notificationRequest.setMessage(profilePOJO.getArthsId() + " followed you in "+getString(R.string.app_name));
        }
