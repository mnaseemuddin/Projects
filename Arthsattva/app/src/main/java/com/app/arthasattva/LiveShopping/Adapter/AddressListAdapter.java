package com.app.arthasattva.LiveShopping.Adapter;
...
import com.app.arthasattva.LiveShopping.Model.AddressListModel;
import com.app.arthasattva.R;
import com.app.arthasattva.databinding.AddressListLayoutBinding;
...
public class AddressListAdapter extends RecyclerView.Adapter<com.app.arthasattva.LiveShopping.Adapter.AddressListAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public com.app.arthasattva.LiveShopping.Adapter.AddressListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (context == null) {
            context = parent.getContext();
        }
        View view = LayoutInflater.from(context).inflate(R.layout.address_list_layout, parent, false);
        return new com.app.arthasattva.LiveShopping.Adapter.AddressListAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull com.app.arthasattva.LiveShopping.Adapter.AddressListAdapter.ViewHolder holder, int position) {
