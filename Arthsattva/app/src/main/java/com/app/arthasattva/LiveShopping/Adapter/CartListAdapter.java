...
import com.app.arthasattva.LiveShopping.Model.CartListModel;
import com.app.arthasattva.R;
import com.app.arthasattva.databinding.CartListLayoutBinding;
...
public class CartListAdapter extends RecyclerView.Adapter<com.app.arthasattva.LiveShopping.Adapter.CartListAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public com.app.arthasattva.LiveShopping.Adapter.CartListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (context == null) {
            context = parent.getContext();
        }
        View view = LayoutInflater.from(context).inflate(R.layout.cart_list_layout, parent, false);
        return new com.app.arthasattva.LiveShopping.Adapter.CartListAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull com.app.arthasattva.LiveShopping.Adapter.CartListAdapter.ViewHolder holder, int position) {
