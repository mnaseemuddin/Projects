...
public class ProfilePOJO implements Serializable {
    ...
    public ProfilePOJO(String email, String name, String userId, String arthsId, String gender, String dob, String hometown, String bio, String image, String mobile, String loginType, String country_name, String country_code, String auth_status, String current_level, int point, int total_recieved_beans, int total_sent_diamonds) {
        this.email = email;
        this.name = name;
        this.userId = userId;
        this.arthsId = arthsId;
        this.gender = gender;
        this.dob = dob;
    ...
    public void setArthsId(String arthsId) {
        this.arthsId = arthsId;
    }
