...
import com.app.arthasattva.BuildConfig;
...
public class OfflineFun extends Application {
    ...
    private void setupRemoteConfig() {
        ...
        remoteConfig.fetch(30)// fetch notificationModel from firebase every 5 seconds ,in real world,you need make it to 1 min , min etc
