...
import com.app.arthasattva.activity.CommentActivity;
import com.app.arthasattva.activity.MainActivity;
import com.app.arthasattva.activity.SendPostActivity;
...
import com.app.arthasattva.model.ReportReasonModel;
    ...
    private void pushLikeNotification() {
        ...
        if (null != profilePOJO.getName()) {
            if (!profilePOJO.getName().isEmpty()) {
                ...
                notificationRequest.setContext_message("<strong>" + profilePOJO.getArthsId() + "</strong>" + " liked your post ");
            }
        } else {
            notificationRequest.setContext_message("<strong>" + profilePOJO.getArthsId() + "</strong>" + " liked your post ");
        }
