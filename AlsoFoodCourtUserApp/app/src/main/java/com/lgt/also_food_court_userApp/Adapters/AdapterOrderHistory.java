...
public class AdapterOrderHistory extends RecyclerView.Adapter<AdapterOrderHistory.HolderOrder> {

    private List<ModelOrderHistory> listOrders;
    private Context context;

    public AdapterOrderHistory(List<ModelOrderHistory> listOrders, Context context) {
    ...
    public void onBindViewHolder(@NonNull HolderOrder holder, final int position) {
        ...
        Glide.with(context).load(listOrders.get(position).getImage()).diskCacheStrategy(DiskCacheStrategy.ALL)
        ...
        holder.tvNameOrder.setText(listOrders.get(position).getProducts_name());
        holder.tvOrderID.setText(listOrders.get(position).getOrder_number());
        holder.tvAmountOrder.setText(listOrders.get(position).getTotal_price());
